...
function Register() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("http://127.0.0.1:8000/api/auth/users/", {
            ...
            alert(err.response?.data?.password?.[0] || "Registration failed");
        }
    };
...
_s(Register, "Mcubm9vhYvtt1A/CU4MpdXbrnm0=", false, function() {
    return [
